...
const ZH_AR = {
  'applications/cnc-tool-vending-machine.html': { zh: '用于切削刀具、刀片、立铣刀和丝锥的 CNC 刀具自动售货机', ar: 'ماكينة بيع أدوات CNC للأدوات القاطعة والقاطعات ومرازل الأطراف والصولبات' },
  ...
  'applications/smart-file-cabinet.html': { zh: '用于文档管理、档案存储与文件追踪的智能文件柜', ar: 'خزانة ملفات ذكية لإدارة المستندات وتخزين الأرشيف وتتبع الملفات' },
  ...
  'applications/tool-tracking-system.html': { zh: '用于可循环工具、量具、夹具与资产管控的刀具追踪系统', ar: 'نظام تتبع الأدوات للأدوات القابلة لإعادة الاستخدام والمقاييس والتركيبات ومراقبة الأصول' },
  ...
  'applications/chemical-storage-cabinet.html': { zh: '用于实验室试剂、液体瓶与样本的冷藏化学品存储柜', ar: 'خزانة تخزين كيميائية مبردة لكواشف المختبر والزجاجات السائلة والعينات' },
  ...
  'solutions/electronics-manufacturing-inventory.html': { zh: '用于电子、半导体与 ESD 用品管理的智能柜方案', ar: 'حل خزانة ذكية لإدارة الإلكترونيات وأشباه الموصلات وإمدادات ESD' },
  'solutions/automotive-manufacturing-inventory.html': { zh: '面向汽车与电动汽车零部件制造的工业自动售货机方案', ar: 'حل ماكينة بيع صناعية لتصنيع مكونات السيارات والسيارات الكهربائية' },
  'solutions/medical-device-manufacturing-supplies.html': { zh: '用于医疗器械制造用品与 PPE 的智能柜方案', ar: 'حل خزانة ذكية لمستلزمات تصنيع الأجهزة الطبية ومعدات الوقاية' },
