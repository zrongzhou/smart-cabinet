...
const NAME_MAP = {
  'applications/chemical-storage-cabinet.html': { en: 'Chemical Liquid Management', zh: '化学液体管理', ar: 'إدارة السوائل الكيميائية' },
  'applications/cnc-tool-vending-machine.html': { en: 'CNC Tool Management', zh: 'CNC刀具管理', ar: 'إدارة أدوات CNC' },
  ...
  'applications/smart-file-cabinet.html': { en: 'Documents & Archives', zh: '文档与档案', ar: 'المستندات والأرشيف' },
  'applications/smart-locker-system.html': { en: 'Employee Personal Storage', zh: '员工个人储物', ar: 'التخزين الشخصي للموظفين' },
  'applications/tool-tracking-system.html': { en: 'Reusable Tools & Assets', zh: '可复用工具与资产', ar: 'الأدوات القابلة لإعادة الاستخدام والأصول' },
  'automated-storage-cabinet.html': { en: 'Micro Warehousing Cabinets', zh: '微型仓储柜', ar: 'خزائن التخزين المصغرة' },
  'cnc-tool-vending-machines.html': { en: 'CNC Tool Vending Machines', zh: 'CNC刀具自动售货机', ar: 'ماكينات بيع أدوات التصنيع CNC' },
  ...
  'solutions/automotive-manufacturing-inventory.html': { en: 'Automotive and EV Components Manufacturing', zh: '汽车与电动汽车零部件制造', ar: 'تصنيع مكونات السيارات والمركبات الكهربائية' },
  ...
  'solutions/electronics-manufacturing-inventory.html': { en: 'Electronics, Semiconductor, Electrical and Optical Manufacturing', zh: '电子、半导体、电气与光学制造', ar: 'تصنيع الإلكترونيات وأشباه الموصلات والكهرباء والبصريات' },
  ...
  'solutions/medical-device-manufacturing-supplies.html': { en: 'Medical Device and Life Science Equipment Manufacturing', zh: '医疗器械与生命科学设备制造', ar: 'تصنيع الأجهزة الطبية ومعدات علوم الحياة' },
