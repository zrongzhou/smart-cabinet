...
const STRUCTURE = [
  {
    ...
    leaves: [
      { slug: 'sub-cnc-tool-vending-machines', en: 'CNC Tool Vending Machines', zh: 'CNC 刀具自动售货机', ar: 'ماكينات توزيع أدوات CNC', products: ['cnc-tool-vending-machines.html'] },
      ...
      { slug: 'sub-micro-warehousing-cabinets', en: 'Micro Warehousing Cabinets', zh: '微型仓储柜', ar: 'خزائن التخزين المصغرة', products: ['automated-storage-cabinet.html'] },
  ...
  },
  {
    ...
    leaves: [
      { slug: 'sub-cnc-tool-management-ppe', en: 'CNC Tool Management / PPE & Safety Supplies', zh: 'CNC 刀具管理 / 劳保安全防护用品', ar: 'إدارة أدوات CNC / مستلزمات السلامة PPE', products: ['applications/cnc-tool-vending-machine.html', 'applications/ppe-vending-machine.html'] },
      { slug: 'sub-fasteners-documents', en: 'Fasteners & Consumables / Documents & Archives', zh: '紧固件耗材 / 文档档案', ar: 'المثبتات والمستهلكات / الوثائق والأرشيف', products: ['applications/fastener-vending-machine.html', 'applications/smart-file-cabinet.html'] },
      ...
      { slug: 'sub-reusable-tools-assets', en: 'Reusable Tools & Assets', zh: '可复用工具与资产', ar: 'الأدوات والأصول القابلة لإعادة الاستخدام', products: ['applications/tool-tracking-system.html'] },
      ...
      { slug: 'sub-chemical-liquid-management', en: 'Chemical Liquid Management', zh: '化学品液体管理', ar: 'إدارة السوائل الكيميائية', products: ['applications/chemical-storage-cabinet.html'] },
    ],
  },
  {
    ...
    leaves: [
      ...
      { slug: 'sub-electronics-manufacturing', en: 'Electronics, Semiconductor, Electrical and Optical Manufacturing', zh: '电子、半导体、电气与光学制造', ar: 'الإلكترونيات وأشباه الموصلات والكهرباء والبصريات', products: ['solutions/electronics-manufacturing-inventory.html'] },
      { slug: 'sub-automotive-manufacturing', en: 'Automotive and EV Components Manufacturing', zh: '汽车与电动汽车零部件制造', ar: 'تصنيع مكونات السيارات والمركبات الكهربائية', products: ['solutions/automotive-manufacturing-inventory.html'] },
      { slug: 'sub-medical-device', en: 'Medical Device and Life Science Equipment Manufacturing', zh: '医疗器械与生命科学设备制造', ar: 'تصنيع الأجهزة الطبية ومعدات علوم الحياة', products: ['solutions/medical-device-manufacturing-supplies.html'] },
