...
export default function CtaSection() {
  ...
  return (
    <section className="relative py-20 px-6 bg-gradient-to-r from-blue-50 to-indigo-50">
      {/* Content */}
      <motion.div 
      ...
      >
        {/* Badge */}
        <div 
          className="inline-flex items-center space-x-2 backdrop-blur-sm border rounded-full px-6 py-2 mb-8 bg-blue-100 border-blue-200"
        >
        ...
        <p 
          className="text-xl mb-10 max-w-2xl mx-auto leading-relaxed text-gray-600"
        >
          {t('cta.readyDesc')}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
          <a
            href={`/${locale}/contact`}
            className="group inline-flex items-center justify-center px-10 py-4 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-lg bg-gradient-to-r from-blue-600 to-blue-400"
            onMouseEnter={(e) => {
          ...
          <a
            ...
            className="group inline-flex items-center justify-center px-10 py-4 font-semibold rounded-xl hover:bg-blue-50 transition-all duration-300 text-lg border-2 border-blue-600 text-blue-600"
          >
        ...
        {/* Contact Info */}
        <div 
          className="inline-flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 text-sm font-semibold px-6 py-3.5 rounded-full border bg-white border-blue-200 text-gray-700"
        >
          <div className="flex items-center space-x-2.5">
            <span 
              className="flex items-center justify-center w-7 h-7 rounded-full border bg-blue-50 border-blue-200"
            >
