...
import ProductFaqEditor, { type FaqItem, normalizeFaq } from '@/components/product/ProductFaqEditor';
...
export default function EditBlogPage() {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          // V8.11 — pre-fill the structured FAQ list (normalizeFaq tolerates
          // null / string / partial shapes coming from the API).
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/xiaozhouBackend/blog');
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-4">
        <Link href="/xiaozhouBackend/blog" className="text-gray-500 hover:text-gray-700"><ArrowLeft className="w-5 h-5" /></Link>
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-4">
          <Link href="/xiaozhouBackend/blog" className="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors">
            取消
          </Link>
